/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-file=.dev.vars.template` (hash: 2620f65e610ebd74f3a5c0a23e322a5d)
...
interface __BaseEnv_Env {
	...
	ACCESS_KEY: string;
	REFUSALS: DurableObjectNamespace<import("./src/index").RefusalCounter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RefusalCounter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCESS_KEY">> {}
}
